...
M_BOX(GP_LEFT, GP.LABEL(DISPLAY_SECONDS_SWITCH[mydata.lng]); M_BOX(GP_RIGHT, GP.SWITCH("seconds_switch", mydata.seconds_switch, GP_BLUE);););
  ...
  *_GPP += F("<style>.spinner{display:inline-flex!important;margin:0!important;padding:0!important;border:none!important;background:none!important;align-items:center!important}.spinner input[type=number]{margin:0!important;padding:0!important;font-size:12px!important;width:40px!important;border:1px solid #aaa!important;border-radius:3px!important;text-align:center!important;vertical-align:middle!important}.spinner button{display:inline-flex!important;align-items:center!important;justify-content:center!important;font-size:14px!important;width:24px!important;height:26px!important;padding:2px!important;margin:0!important;border:1px solid #aaa!important;border-radius:3px!important;background:#f0f0f0!important;cursor:pointer!important;box-sizing:border-box!important;text-align:center!important}</style>");
