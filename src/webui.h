...
M_BOX(GP_LEFT, GP.LABEL(DISPLAY_SECONDS_SWITCH[mydata.lng]); M_BOX(GP_RIGHT, GP.SWITCH("seconds_switch", mydata.seconds_switch, GP_BLUE);););
  ...
  *_GPP += F("<style>.spinner{display:inline-flex!important;margin:0!important;padding:0!important;border:none!important;font-size:0!important;background:none!important}.spinner input[type=number]{margin:0!important;padding:0!important;font-size:12px!important;width:40px!important;border:1px solid #aaa!important;border-radius:3px!important;text-align:center!important}.spinner button{display:none!important}</style>");
