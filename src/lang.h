...
const char* BUZZER_INTERVAL[] = {"Интервал:", "Interval:"};
const char* BUZZER_INTERVAL_OPTIONS[] = {"Каждые 5мин,Каждые 10мин,Каждые 30мин,Каждый час", "Every 5 min,Every 10 min,Every 30 min,Every hour"};
const char* BUZZER_DURATION[] = {"Длительность (мс):", "Duration (ms):"};
const char* BUZZER_VOLUME[] = {"Громкость:", "Volume:"};
const char* BUZZER_MELODY[] = {"Сигнал:", "Beep:"};
const char* BUZZER_MELODY_OPTIONS[] = {"Двойной,Тройной,Вверх,Вниз,Сирена,Короткий", "Double,Triple,Up,Down,Siren,Short"};
